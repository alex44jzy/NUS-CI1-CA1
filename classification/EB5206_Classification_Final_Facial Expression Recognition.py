...
with open("C:/Users/zhylucky/Desktop/CA-Classification/classification/classify_expression/fer2013/fer2013/fer2013.csv") as f:
    content = f.readlines()
...
plt.plot(history_vgg10.history['acc'])  
plt.plot(history_vgg10.history['val_acc'])  
...
plt.plot(history_vgg10.history['loss']) 
plt.plot(history_vgg10.history['val_loss'])
plt.title('model accuracy')  
plt.ylabel('accuracy')  
plt.xlabel('epoch')  
plt.legend(['training','test'], loc='upper left')  
